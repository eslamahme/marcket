...
import 'package:marcket/screens/auth_screen.dart';
import 'package:marcket/screens/splash_screen.dart';
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProxyProvider<Auth, Order>(
              ...
              update: (ctx, auth, prevOrder) =>
                  Order()..getData(auth.token!, auth.userId!, prevOrder!.order))
        ],
        child:Consumer<Auth>(builder:(ctx,auth,_)=> MaterialApp(
          ...
          routes: {
            ...
            UserScreenProduct.routeName: (ctx) => const UserScreenProduct(),
